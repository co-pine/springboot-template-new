...
public interface UserService extends IService<User> {
    ...
    Boolean updateUserVipInfo(User oldUser, Date vipExpireTime, ZsxqAuthRequest zsxqAuthRequest, String vipType);
    ...
    LoginUserVO userLoginByWxMiniapp(String code, HttpServletRequest request);
}
